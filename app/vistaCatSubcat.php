...
$alert = "";
// Codigo de programa de tabla de cat-subcat
include_once 'objects/usuarios.php';
$otrosUsuarios = new Usuarios ( $db );
$_SESSION['codigo_programa'] = "144";
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Categorias, Subcategorias y Grupos</h3>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
	              				...
	              				<iframe frameBorder="0" scrolling="no" class="responsive-iframe" src="Combobox_3_cat/" width="100%" height="1550px"></iframe>
