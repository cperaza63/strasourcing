...
<body class="form">
    ...
    <div class="form-container">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    ...
                    <div class="form-content">
                        <h1 class=""><a href="http://localhost/strasourcing/app/outside.php"><span class="brand-name" style="color:#5B00B7;">StraSourcing.com</span></a></h1>
        ...
        <div class="form-image">
            ...
            <br><br><br><br><br>
        	<img src="../assets/img/versiónvertical.png" width="640" height="350"  alt=""/>        
        </div>
    </div>
