...
<html lang="en">
<head>
  <title>Actualizacion de Imagenes</title>
  <meta charset="utf-8">
...
<form id="submitForm">
  <div class="row">
      ...
      <div class="col-md-4">
      <button type="submit" name="upload" class="btn btn btn-outline-secondary" style="background-color:#5B00B7; color:white;">Cargar Archivos</button>
      <a href="<?php echo $_SESSION['regresar']?>" target="_parent" class="btn btn btn-outline-secondary">Regresar</a>
      </div>
