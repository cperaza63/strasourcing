...
$_SESSION['codigo_programa'] = "148";
include "partials/validar_acceso.php";


if( isset($_GET['idCompany']) && $_GET['idCompany'] !=""){
	$_SESSION['ll'] = $_SESSION['loginHive'];
	$_SESSION['pp'] = $_SESSION['passwordHive'];
	$stmt = $otrosUsuarios->leerUsuarioAdmin ($_GET['idCompany']);
	$i=0;
	while ( $row = $stmt->fetch ( PDO::FETCH_ASSOC ) )
	{	
		$i++;
		// userHive es el company_padre que esta logueado
		$_SESSION['companyHive'] = $_GET['idCompany'];
		...
		$stmt2 = $empresas->LeerEmpresaId($_GET['idCompany']);
		$i=0;
		while ( $row2 = $stmt2->fetch ( PDO::FETCH_ASSOC ) )
		{	
			$i++;
			$_SESSION['rifHive'] = $row2['numero_rif'];
			$_SESSION['razonSocialHive'] = $row2['razon_social'];
			$_SESSION['logoHive'] = $row2['logo_imagen'];
		}	
		//echo "......................................valores= " . $_SESSION['rifHive'];
		?>
		<script>
			alert("Bienvenido Administrador, ahora usted esta dentro de la empresa.");
	...
	if( $i == 0 ){
		?>
		<script>
			alert("Usted no puede acceder a esta empresa debido a que no hay usuario administrador");
			window.location="<?php echo "dashboard_Proveedores.php"; ?>";
        </script>
        <?php	
	}
}
...
<head>
    ...
    <title>STRASOURCING - To-do List</title>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    ...
                                    <p><?php echo "cod. " . $_SESSION['iduserHive'] . " ( " . $_SESSION['userhive'] . " )"; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown-item">
                            <a href="../html/user_profile.html">
                        ...
                        <div class="dropdown-item">
                            <a href="../html/auth_lockscreen.html">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Datos del Comprador <?php echo "'".$_SESSION['razonSocialHive']."' - " . $_SESSION['companyHive']; ?></h3>
                    </div>
                </div>
                <div class="row layout-top-spacing"></div>
                
                    <div class="container">
                    <iframe src="registrate_gratis/comprador_spa.php" width="100%" height="1800px" frameborder="0" ></iframe>
                    </div>
