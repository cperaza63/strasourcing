...
<main class="container-fluid">
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#form_modal1"> Agregar Servicios Profesionales</button>
    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#form_modal2"> Agregar Servicios en la Planta</button>
    </h6>

    <div class="d-flex text-muted pt-5">
			<table class="table table-bordered">
			<thead class="btn-secondary" style="background-color:#5B00B7; color:white;">
				<tr>
					<th width="5%">#</th>
			...
			<?php
				...
				$sq = "SELECT a.*, if( tipo_servicio = 5, 'Servicios Profesionales', 'Servicioss en Planta') as nombre_servicio FROM servicios_proveedor a where rif='". $_SESSION['rifHive'] ."'";
...
<div class="modal fade" id="form_modal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-secondary" style="background-color:#5B00B7; color:white;">
...
<div class="card bg-light" style="width: 100%;">
  ...
  <div class="row" id="servicios_profesionales">
      ...
      <div class="modal-footer">
        ...
        <button name="guardar" type="submit" class="btn btn-outline-primary">Registrar Ahora</button>
      </div>
      </form>
      </div>
    </div>
