...
include "controllers/estadociudadesController.php";
?>
<!DOCTYPE html>
<html lang="es">
<head>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-secondary text-white">
                                <h5 class="modal-title text-white" id="my-modal-title" >Nueva Ciudad</h5>
                            ...
                            <div class="modal-body">
                                <form action="" method="post" autocomplete="off">
                                    <select name="estado" required class="form-control" id="estado" title="Seleccione estado">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="ciudad" type="text" required class="form-control" id="ciudad" placeholder="Ingrese Usuario">
                                    </div>
                                    <input type="submit" name="registrar" value="Registrar" class="btn btn-secondary">
                                    <a href="vistaEstadosCiudades.php" class="btn btn-secondary">Cancelar</a>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
              				...
              				<form method="post" action="vistaEstadosCiudades.php">
                              <div class="row">
                                <div class="col-lg-3">
                                  <input name="buscarpor" type="text" class="form-control" id="buscarpor" placeholder="Coloque ciudad / estado" value="<?php echo $buscar?>">
                                </div>
                                <div class="col-lg-1">
                                  <button class="btn btn-secondary mb-2" type="submit"><i class="fas fa-search"></i></button>
                                </div>
                                <div class="col-lg-1">
                                  <button class="btn btn-outline-primary" type="button" data-toggle="modal" data-target="#nuevo_usuario"><i class="fas fa-plus"></i></button>
                                </div>
                              </div>
                            </form>
                                <div class="table-responsive mb-4">
                                    <table id="style-3" class="table style-3  table-hover">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="color: #2E005B;">Pais</th>
                                                <th style="color: #2E005B;">Cod Estado</th>
                                                <th style="color: #2E005B;">Cod Ciudad</th>
                                                <th style="color: #2E005B;">Nombre Estado</th>
                                                <th style="color: #2E005B;">nombre Ciudad</th>
                                        ...
                                        <?php
										$tipoUsuario = 0;
										$stmt = $estadoCiudades->readList ($buscar); 
										while ( $row = $stmt->fetch ( PDO::FETCH_ASSOC ) ) 
										{	
										?>
	                                        <tr>
                                                <td><span id="pais"><?= $row['pais'] ;?></span></td>
                                                <td><span id="state"><?= $row['state']?></span></td>
                                                <td><span id="id"><?= $row['id']?></span></td>
                                                <td><span id="nombreEstado"><?= $row['nombreEstado']?></span></td>
                                                <td><span id="nombreCiudad"><?= $row['city']?></span></td>
											...
											<?php 
											include "modals/modal_estados_delete.php"; 
										}
										?>
                                        </tbody>
                                    </table>
