...
if( isset($_GET['cat'])){
	$_SESSION['cat_selected'] = $_GET['cat'];
	$_SESSION['nombrecat_selected'] = $_GET['nombre_cat'];
	$_SESSION['imagencat_selected'] = $_GET['imagen_cat'];
}
...
$bigdata->programa = 'spaDirectorio_categorias';
$bigdata->agregar = 0;
$bigdata->modificar = 0;
$bigdata->eliminar = 0;
$bigdata->consultar = 1;
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="card">
	                <iframe src="filtro_negocios/index.php?cat=<?php echo $_SESSION['cat_selected']; ?>" style="overflow: hidden" scrolling="no" width="100%" height="3550px" frameborder="0" ></iframe>
                </div>

                </div>
        		<div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2023 <a target="_blank" href="https://strasourcing.com">CP&JCL</a>, todos los derechos reservados.</p>
                </div>
