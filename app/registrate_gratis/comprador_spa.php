...
<?php
include "comprador_spa_accion.php";
?>
<!doctype html>
...
<head>
    ...
    <meta name="author" content="Carlos Peraza - Juan Carlos Latouche">
    <meta name="generator" content="CP&JC 0.111.3">
...
<main >
            ...
            <div class="col-12 d-flex justify-content-center align-items-end"> 
                ...
                <div class="d-flex gap-2 justify-content-center py-5">
                  ...
                  <button type="submit" name="boton" value="administrador" class="btn btn-<?php echo $color_administrador;?> d-inline-flex align-items-center" >
                   ...
                   <a target="_parent" href="http://localhost/STRASOURCING/app/<?php echo $_SESSION['dashboard']; ?>" class="btn btn-outline-secondary d-inline-flex align-items-center" style=" color:#5B00B7">
                    Menu ppal
                    <svg class="bi ms-1" width="20" height="20"><use xlink:href="#arrow-right-short"/></svg>
                  </a>
                </div>
	...
	?>
        ...
        <form action="comprador_spa.php" method="post">
            <h4 class="fst-italic">Información de quien registra la empresa  </h4>
	...
	?>
    	<div class="row center-h center-v" >
	        <form action="comprador_spa.php" method="post">
              <h4 class="fst-italic">De quien representa a la empresa</h4>
	...
	<div class="p-4 mb-3 bg-secondary-subtle rounded">
      <form action="comprador_spa.php" method="post">
    <h4 class="fst-italic">Información del Comprador</h4>
          <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1"><i class="bi-person-circle"></i></span>
                ...
                <i class='bi bi-card-image'></i></button>                    
                  <div align="center"><img src="../../assets/documentos/imagenes/logos/<?php echo $logo_imagen; ?>" height="80"  alt="" /></div>
                      ...
                      <div class="modal-content">
                        <div class="modal-body">
                          ...
                          <div class="container_modal"> 
                              <iframe class="responsive-iframe" src="../subirUnArchivo/index1.php?tipoEmpresa=3&tipoTabla=12&idCompany=<?php echo $_SESSION['companyHive']; ?>&folder=<?php echo "/assets/documentos/imagenes/logos/"; ?>"></iframe>
                          </div>
                         <!-- </p>-->
                        </div>
    ...
    <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input name="company_rif" type="text" required class="form-control" placeholder="escriba su número de RIF del negocio <?php echo $company_rif; ?>" min="1" value="<?php echo $company_rif; ?>"  aria-describedby="basic-addon1">
                        ...
                        <div id="myModalSoporteRif" class="modal">						
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>
                              <div class="container_modal"> 
                                  <iframe class="responsive-iframe" src="../subirUnArchivo/index1.php?tipoEmpresa=3&tipoTabla=14&idCompany=<?php echo $_SESSION['companyHive']; ?>&folder=<?php echo "/assets/documentos/imagenes/rif/"; ?>"></iframe>
                              </div>
                              </p>
                            </div>
                            <div class="modal-footer">
        ...
        <div class="form-group">
                          <label class="small mb-1" for="pais_edo_city"><i class="fas fa-building"></i> <strong>Dirección de su negocio (<?php echo $latitude, $longitude;?>)</strong></label>
                          <?php
                    ...
                    <div class="input-group mb-3">
                      ...
                      <textarea name="company_address" cols="50" rows="2" required class="form-control" placeholder="Direccion de la empresa" aria-label="With textarea" value="<?php echo ""; ?>"><?php echo $company_address; ?></textarea>
                        
                      <div class="form-inline">
                        <button id="myBtnSoporte" type="button" class="btn btn-secondary" style="background-color:#5B00B7; color:white;" title="coordenadas de la empresa">
                      ...
                      <div id="myModalSoporte" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container_modal">
                                <iframe class="responsive-iframe" src="../ubicacionGeografica.php?tipo=proveedor"></iframe>
                                </div>
                            </div>
                            <div class="modal-footer"> 
                            <a href="comprador_spa.php&accion=spa&titulo_pagina=Actualización de datos de la empresa Proveedor">
                                <button class="btn btn-secondary" style="background-color:black; color:white;">
...
<footer align="center" class="blog-footer" style="background-color:black; color:white;">
  Desarrollado por CP&JCL <a href="https://>strasourcing.com/">StraSourcing</a>.
  <p>
    <a href="#">ir Arriba</a>
  </p>
</footer>
