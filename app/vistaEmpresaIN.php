            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Datos de la Empresa Comprador</h3>
                    </div>
                </div>
                        ...
                        <div class="mail-box-container">
                            ...
                            <div class="tab-title">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12 text-center">
                                        ...
                                        <h5 class="app-title">Secciones</h5>
                                    </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-12 mt-4 pl-0">
                                            <ul class="nav nav-pills d-block" id="pills-tab" role="tablist">
                                                <li class="nav-item">
                                                    ...
                                                    <a href="http://localhost/STRASOURCING/app/vistaempresaIN.php?op=1" class="nav-link list-actions active" id="all-list" role="tab" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3" y2="6"></line><line x1="3" y1="12" x2="3" y2="12"></line><line x1="3" y1="18" x2="3" y2="18"></line>
                                                    </svg> Datos empresa<span class=""></span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://localhost/STRASOURCING/app/vistaempresaIN.php?op=2" class="nav-link list-actions" id="todo-task-done" role="tab" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-thumbs-up"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path>
                                                    </svg> Administrador <span class=""></span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://localhost/STRASOURCING/app/vistaempresaIN.php?op=3" class="nav-link list-actions" id="todo-task-important" role="tab" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                                    </svg> Contacto <span class=""></span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://localhost/STRASOURCING/app/vistaempresaIN.php?op=4" class="nav-link list-actions" id="todo-task-trash" role="tab" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line>
                                                    </svg> Menu ppal</a>
                                                </li>
                                            </ul>
                                        </div>
							...
							<div class="col-md-8 col-sm-8 col-8 text-center">
								...
								if(isset($_GET['op'])){
									...
									if ( $_GET['op'] == 1 ){
										echo "Aqui el programa 1 ";
									}
									
									if ( $_GET['op'] == 2 ){
										echo "Aqui el programa 2 ";
									}
	
									if ( $_GET['op'] == 3 ){
										echo "Aqui el programa 3 ";
									}
	
	
									if ( $_GET['op'] == 4 ){
										echo "Aqui el programa 4 ";
									}
								}
								?>
							</div>
