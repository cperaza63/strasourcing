...
$_SESSION['regresar'] = "../vistaTablaControl.php";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="main-container" id="container">
                    ...
                    <div class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
	                            ...
	                            <iframe frameBorder="0" class="responsive-iframe" src="crud_imagenes/index.php?id=<?php echo $_SESSION['codigo_tabla']; ?>" width="100%" height="3500px">
                                </iframe>
        ...
        <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2023 <a target="_blank" href="https://straSourcing.com">strasourcing.com</a>, todos los derechos reservados.</p>
                </div>
