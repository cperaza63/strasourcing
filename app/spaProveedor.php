...
if( isset($_GET['idCompany']) && $_GET['idCompany'] !=""){
	...
	$_SESSION['iduserHive'] = $_SESSION['iduserHive'];
	...
	{	
		...
		$stmt2 = $proveedores->LeerProveedorId($_GET['idCompany']);
		$i=0;
		...
		?>
		<script>
			alert("Bienvenido Administrador, ahora usted esta dentro de la de un proveedor.");
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Datos de la Empresa Proveedora</h3>
                    </div>
                </div>
                <div class="row layout-top-spacing"></div>
                
                    <div class="card">
                    <iframe src="registrate_gratis/proveedor_spa.php" style="overflow: hidden" scrolling="no" width="100%" height="3550px" frameborder="0" ></iframe>
                    </div>
