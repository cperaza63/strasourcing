...
$tituloListaD = "Listar por Marcas";	
...
/*echo "<br>cc= "  . $_SESSION['changeSubcat'] ;
...
if (!isset($_SESSION['idcategoriaR'])){
...
if($_SESSION['changeSubcatT']==1){
	if ($condicion_catT==""){
		...
		on (a.idcategoria = b.id) where tipo=3 and programa='fichaTecnica' and consultar=1 
		...
		on (a.idsubcategoria = b.id) where tipo=3 $condicion_catT and programa='fichaTecnica' and consultar=1
	...
	if ($condicion_catT==""){
		...
		on (a.idgrupo = b.id) where tipo=3 and programa='fichaTecnica' and consultar=1 
...
if($_SESSION['changeSubcat']==1){
	if ($condicion_cat==""){
		// es categora y se cuenta las categorias en general $_SESSION['companyHive']
		...
		where tipo=3 $condicion_cat and programa='fichaTecnica' and consultar=1 
		group by year(datetime) desc, month(datetime) desc, day(datetime) desc, idsubcategoria limit 20";
		$result = mysqli_query($connection, $sql) or die("Error in Selecting " . mysqli_error($connection));	
	}
}else{
...
<head>
    ...
    <title>StraSourcing - Dashboard Compradores</title>
    <link rel="icon" type="image/x-icon" href="html/assets/img/favicon.ico"/>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Sistema StraSourcing - Compradores</h3>
                    </div>
                </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="widget widget-chart-one">
                          <div class="widget-heading">
                                ...
                                <ul class="tabs tab-pills">
                                    <li><a href="javascript:void(0);" id="tb_1" class="tabmenu">Mes/Año</a></li>
                                </ul>
                                <br>
                            </div>
                            <form method="post" action="">
                            ...
                            <iframe frameBorder="0" style="overflow: hidden; " onload="resizeIframe(this)" 
                                ...
                                src="http://localhost/strasourcing/app/chartjs-linealDoble/indexBarra.php?condicion_catM=<?php echo $condicion_catM; ?>">
                            </iframe>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="widget widget-chart-one">
                          <div class="widget-heading">
                                ...
                                <ul class="tabs tab-pills">
                                    <li><a href="javascript:void(0);" id="tb_1" class="tabmenu">Dia/Mes</a></li>
                                </ul>
                            </div>
                            <form method="post" action="">
                          ...
                          <iframe frameBorder="0" style="overflow: hidden; " onload="resizeIframe(this)" 
                            scrolling="no" width="100%" height="300px" src="http://localhost/strasourcing/app/chartjs-linealDoble/?condicion_catD=<?php echo $condicion_catD; ?>">
                            </iframe>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12 layout-spacing">
                    	<div class="widget widget-chart-one">
                            <div class="widget-heading">
                                ...
                                <ul class="tabs tab-pills">
                                    <li><a href="javascript:void(0);" id="tb_1" class="tabmenu">03/23 04/23 05/23</a></li>
                                </ul>
                            </div>
