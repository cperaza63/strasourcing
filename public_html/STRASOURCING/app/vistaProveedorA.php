...
include "controllers/proveedorController.php";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <br>
                <form method="post" action="vistaProveedorA.php">
                    <div class="row">
                      <div class="col-lg-2">
...
<option value="<?php echo $row['codigo']; ?>" <?php if($cty == $row['codigo'] ) echo "selected" ?> > <?php echo $row['city']; ?></option>
                            ...
                            class="btn btn-secondary" type="button" data-toggle="modal" data-target="#nuevo_usuario"><i class="fas fa-plus"></i>
                                ...
                                <div class="table-responsive mb-4">
                                    <table id="style-3" class="table style-3  table-hover">
										...
										$tipoUsuario = 0;
										//echo $edo, $cty, $buscar;
										$stmt = $proveedores->LeerProveedores($edo, $cty, $buscar); 
										while ( $row = $stmt->fetch ( PDO::FETCH_ASSOC ) ) 
										{	
										?>
	                                        <tr>
                                                ...
                                                <td><span style="color:#000" id="numero_rif"><strong><?= $row['numero_rif']?>
                                                
                                                <?php 
												echo "<br>#Contrato: ".$row['contrato'];
                                                ...
                                                <?php
													...
													case 0:
														?>
														<a href="vistaProveedorA.php?id=<?=$row['id']?>&accion=1"><span class="shadow-none badge badge-danger">Inhabilitado</span></a>
														<?php
														break;													
													case 1:
														?>
														<a href="vistaProveedorA.php?id=<?=$row['id']?>&accion=0"><span class="shadow-none badge badge-primary">Activo</span></a>
														<?php
														break;
													}
												?>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        ...
                                                        <li><a href="spaProveedor.php?idCompany=<?=$row['id']?>"
                                                        class="bs-tooltip" 
                                                        data-placement="top" 
                                                        data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                                         ...
                                                         <li><span
                                                        data-toggle="modal" 
                                                        data-target="#contratoProveedor<?=$row['id']?>" 
                                                        class="bs-tooltip" 
                                                        data-placement="top" 
											...
											<?php 
											include "modals/modal_proveedor_delete.php"; 
											include "modals/modal_proveedor_contrato.php";
										}
										?>
                                        </tbody>
                                    </table>
        ...
        <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2023 <a target="_blank" href="https://straSourcing.com">StraSourncing.com</a>, All rights reserved.</p>
                </div>
