...
include "controllers/recomendacionesRifEmpControllerExt.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                <div class="page-header">
                    <div class="page-title">
                        <h3>Recomendaciones dadas por <?php echo $_SESSION['empresa_externa'] . " " . $_SESSION['consulta_rif'];?></h3>
                    </div>
                </div>
			...
			if( isset ( $_GET['idRecomendar'] ) &&  $_GET['idRecomendar'] != "" ){
				...
				?>
                <div class="col-xl-11 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing" style="background-color:white;">
                  <form method="post" action="recomendacionesEmpRif.php">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a class="btn btn-secondary" href="recomendacionesEmpRif.php">Cancelar</a>
                      </div>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="order-summary">
									<?php
										...
										$sql_department = "SELECT * FROM solicitud_categorias WHERE estatus=0 AND rif = '".$_SESSION['consulta_rif']."'";
									  	$department_data = mysqli_query($conexion,$sql_department);
									  	$cuantos_pendientes = $department_data->num_rows;
										
										$sql_department = "SELECT * FROM solicitud_categorias WHERE estatus=1 AND  rif = '".$_SESSION['consulta_rif']."'";
									  	$department_data = mysqli_query($conexion,$sql_department);
									  	$cuantos_aprobados = $department_data->num_rows;
										
										$sql_department = "SELECT * FROM solicitud_categorias WHERE estatus=2 AND  rif = '".$_SESSION['consulta_rif']."'";
									  	$department_data = mysqli_query($conexion,$sql_department);
                            ...
                            <div class="widget-content">
                                ...
                                <div class="mt-container mx-auto">
                                    <div class="timeline-line">
										...
										WHERE a.rif = '" . $_SESSION['consulta_rif'] . "' order by a.date";
										//echo "===" . $query;
                                        $result = mysqli_query($conexion, $query);
                                        if ( !$result ) {
                                            die('Query Failed...');
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
											...
											inner join empresas b on (a.rif = b.numero_rif) WHERE a.rif = '".$_SESSION['consulta_rif'] . 
												...
												while( $row = mysqli_fetch_array( $result ) ) {
                                                    ...
                                                    <tr>
														...
														if($ne == "warning"){
                                                            ...
                                                            <a class="btn btn-secondary" href="recomendacionesEmpRif.php?idRecomendar=<?php echo $row['id']; ?>">Evaluar</a>
                                                            </td>    
                                                            <?php
														}else{
															?>
