<div class="modal fade" id="contratoProveedor<?=$row['id']?>" role="dialog">
  <form  method="post" action="../app/vistaProveedorA.php">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Actualización contrato del Proveedor</h4>
        </div>
        ...
        <div class="modal-footer">
          <button name="modal_contrato_proveedor" value="actualizar" type="submit" class="btn btn-success">Si, actualizar</button>
